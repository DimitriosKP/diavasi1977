    ...
    <body>
        ...
        <div class="info">
            <section class="cards-area" id="info-section">
                <h1>Ποιοί είμαστε</h1>
                <p class="text-justify">Μια από τις καθιερωµένες αξίες για καλό φαγητό στην πόλη, το εστιατόριο Διάβαση συνεχίζει από το 1977 
                    να δηµιουργεί... πιστούς θαµώνες. Ξεκινώντας από τον Άγγελο Χαντακή, έναν από τους καλύτερους ψήστες στη Θεσσαλονίκη, 
                    master του γύρου, σήµερα τα ηνία έχει αναλάβει η... επόµενη γενιά, στην οποία ο ιδρυτής έχει µεταλαµπαδεύσει την εµπειρία 
                    τόσων χρόνων αλλά και το µεράκι του. Συνδυάζοντας παραδοσιακά και µοντέρνα στοιχεία στην αισθητική του, ξεχωρίζει εδώ και 
                    δεκαετίες για τα ζουµερά και πεντανόστιµα σουτζουκάκια του και φυσικά τον... διάσηµο γύρο του, που συνοδεύονται άψογα από 
                    σπιτικές πατάτες, χειροποίητη ρώσικη αλλά και πληθωρικές δροσερές σαλάτες, όλα από αγνές πρώτες ύλες. Δεν υπάρχει επώνυµος 
                    και µη Θεσσαλονικιός που να µην έχει περάσει από εδώ και να µην έχει φύγει µε τις καλύτερες εντυπώσεις για την ποιότητα, 
                    τις χορταστικές µερίδες και τις εξαιρετικές τιµές. Στα συν η ενηµερωµένη κάβα ελληνικών κυρίως κρασιών. Ο όμορφα 
                    διακοσμημένος χώρος, η υψηλού επιπέδου εξυπηρέτηση σε συνδυασμό με τις υψηλού επιπέδου γεύσεις θα σας οδηγήσουν σε μια 
                    οικειότητα από την πρώτη κιόλας στιγμή. Σπεσιαλιτέ της Διάβασης είναι τα σουτζουκάκια και ο γύρος, ενώ διαθέτει μεγάλη 
                    ποικιλία σε ψητά της ώρας. Συνοδέψτε τα με φρεσκοκομμένες τηγανιτές πατάτες, μελιτζανοσαλάτα ή ρώσικη, καθώς και με το 
                    αγαπημένο σας κρασί ή ποτό, αφού θα το βρείτε σίγουρα μέσα από την μεγάλη κάβα που διαθέτει.</p>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="thumbnail">
